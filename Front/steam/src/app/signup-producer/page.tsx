    ...
    <div className="bg-gray-700 grid grid-rows-[20px_1fr_20px] gap-4 items-center justify-items-center min-h-screen p-8 pb-20 sm:p-20 font-[family-name:var(--font-geist-sans)]">
        ...
        <form className="bg-gray-800 p-2 flex gap-4 flex flex-col rounded-lg" onSubmit={handleSignup}>
          <div className="flex flex-col">
            <label className="text-blue-400" htmlFor="username">Nome da Produtora</label>
          ...
          <p className="text-gray-400 text-sm">Já tem uma conta na Steam? <a className="underline" href="/login-producer">Entre com sua conta</a></p>
          <p className="text-gray-400 text-sm"> É um usuário normal? <a className="underline" href="/signup">Se cadastre aqui</a> </p>
        </form>
      </main>
      <Footer/>
    </div>
